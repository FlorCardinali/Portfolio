...
const Studies = () => {
    ...
    return ( 
        ...
        <div id="education-section">
               ...
               <article className="text-contrast  px-5 py-12 mx-auto flex flex-wrap justify-center w-screen">
                    ...
                    <div className="flex flex-col  flex-wrap  lg:text-left w-fll h-full">
                        ...
                        <ItemStudy 
                            ...
                            subtitle="Bahía HUB"
                            contenido="Modelado 3D de figuras utilizando variedad de estilos. Diseño con voxeles basicos y figuras mas complejas en blender.    " 
                            link="https://drive.google.com/file/d/11MXbF0I1kOLUNDVUFP1yE8-3JzblJ1qW/view"
                            img="/bahiahub.jpg"/>
            ...
            <section className="w-screen pt-32 bg-bgColor text-contrast ">
                <Title
                ...
                <Title
                    title="Tecnologías Aplicadas en Proyectos"
                    content=""
                    />
                ...
                <div className="pt-16 mx-[12rem] flex flex-wrap gap-10 items-center justify-center">
                    ...
                    {/* MySQL */}
                    <div className="flex flex-col items-center gap-4 hover:scale-125 transition-all duration-300 h-26 w-18">
