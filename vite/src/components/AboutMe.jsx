             ...
             <section >
                <div className="bg-contrast gap-12 flex lg:flex-row flex-col-reverse items-center lg:items-center justify-center h-auto p-12 ">
                    ...
                    <article className="gap-4 flex flex-col text-center lg:text-right text-bgColor w-[100%] lg:w-[40%]">
                        ...
                        <p id="about-text">
                        Me presento, yo soy <span className={spam_style}>Florencia Cardinali</span>, Estoy por terminar una <span className={spam_style}>Tecnicatura Universitaria en Programación</span> en la Universidad Tecnológica Nacional. 
                        ...
                        Me gusta centrarme en la calidad de los proyectos, en la <span className={spam_style}>legibilidad del codigo</span> y su limpieza, basciamente, si puedo dejar el código mas limpio que como lo encontre, mejor.
                        Los ámbitos en donde más me he desarrollado son el  <span className={spam_style}>desarrollo de videojuegos</span> en Unity y Godot, y el <span className={spam_style}>desarrollo web </span> tanto frontend como backend.
                        Tengo una discapacidad visual parcial del 76%, sin embargo, esto no me limita en mi carrera y pienso seguir creciendo y <span className={spam_style}>estudiando siempre</span>. 
                        </p>
                    </article>
