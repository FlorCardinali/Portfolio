...
const NavBar = () => {
    ...
    <div className="relative z-40">
        <div className= "justify-between flex md:px-12 px-6 py-3 gap-4 md:gap-0  md:flex-row fixed w-screen bg-bgColor/30 h-[55px]">
            ...
            <nav className=" basis-1/3 gap-8 grow flex-row justify-end items-center mr-5 text-base lg:flex hidden">
            ...
            <nav className={`${open ? "right-0" : "-right-full"} top-[55px] bg-bgColor/30 w-screen flex flex-col space-y-5 absolute items-center p-5 text-xl transition-all duration-500 `}>
                <a href="#" className="text-primary text-[18px] font-extrabold hover:text-white cursor-pointer ">Inicio</a>
                <a href="#about-section" className={aStyles}>Sobre Mi</a>
                <a href="#experience-section" className={aStyles}>Experiencia</a>
                <a href="#proyects-section" className={aStyles}>Proyectos</a>
